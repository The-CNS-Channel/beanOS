...
ENABLE_BEANSPLORER=${ENABLE_BEANSPLORER:-true}
ENABLE_BEANOS=${ENABLE_BEANOS:-true}

### Check distro

if [ ! -f /etc/lsb-release ]; then
    echo "Not an Ubuntu container, add logic for your distro to the beanOS feature or use Ubuntu"
    exit 1
fi
